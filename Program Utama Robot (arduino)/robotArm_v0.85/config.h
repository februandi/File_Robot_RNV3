...
#define X_HOME_STEPS 900 //765 //860 // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM (Z)
...
#define SERVO_GRIP_DEGREE 130// Nilai Maksimal servo terbuka
#define SERVO_UNGRIP_DEGREE 65 //Nilai Maksimal servo mencapit   
