...
#define X_HOME_STEPS 950 //765 //860 // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM (Z)
#define Y_HOME_STEPS 800 //1940 // STEPS FROM Y_ENDSTOP TO INITIAL_XYZ FOR LOWER ARM (Y)
...
#define SERVO_GRIP_DEGREE 160// Nilai Maksimal servo terbuka
#define SERVO_UNGRIP_DEGREE 100 //Nilai Maksimal servo mencapit   
