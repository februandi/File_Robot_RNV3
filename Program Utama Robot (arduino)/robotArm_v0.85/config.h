...
#define END_EFFECTOR_OFFSET 76.9// LENGTH FROM UPPER SHANK BEARING TO MIDPOINT OF END EFFECTOR IN MM
...
#define X_HOME_STEPS 1300 //765 //860 // STEPS FROM X_ENDSTOP TO INITIAL_XYZ FOR UPPER ARM (Z)
#define Y_HOME_STEPS 750 //1940 // STEPS FROM Y_ENDSTOP TO INITIAL_XYZ FOR LOWER ARM (Y)
#define Z_HOME_STEPS 3400 // STEPS FROM Z_ENDSTOP TO INITIAL_XYZ FOR ROTATION CENTER (X)
#define E0_HOME_STEPS 200 // STEPS FROM E0_ENDSTOP TO INITIAL_E0
...
#define SERVO_GRIP_DEGREE 140// Nilai Maksimal servo terbuka
#define SERVO_UNGRIP_DEGREE 80 //Nilai Maksimal servo mencapit   
...
#define Z_MAX (LOW_SHANK_LENGTH+70.0) //SHANK_LENGTH ADDING ARBITUARY NUMBER FOR Z_MAX
